...
const INPUT_BASE_CLASSES =
  'w-full px-3 py-2 border rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-offset-1 dark:focus:ring-offset-gray-800 transition-colors duration-200';
...
const VALIDATION_CLASSES = {
  ...
  success: 'border-green-500 dark:border-green-600 focus:ring-green-500 focus:border-green-500',
};
